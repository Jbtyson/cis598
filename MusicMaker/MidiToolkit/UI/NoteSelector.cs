...
namespace Multimedia.Midi.UI
{
	...
	/// </summary>
	public class NoteSelector : System.Windows.Forms.UserControl
	{
        ...
        { 
            ...
            if(cboNote.SelectedIndex > (int)Note.G)
            {
        ...
        private void cboOctave_SelectedIndexChanged(object sender, System.EventArgs e)
        {
            ...
            if(cboOctave.SelectedIndex == OctaveMax)
            {
                ...
                if(cboNote.Items.Count - 1 > (int)Note.G)
                {
                    //
            ...
            else
            {
                ...
                if(cboNote.Items.Count - 1 < (int)Note.GSharp)
                {
                    //
                    // Add the note back.
                    // 
